...
#ifdef SECBIT
void SMTChecker::analyze(SourceUnit const& _source, shared_ptr<Scanner> const& _scanner, bool _isSECBIT)
{
...
#ifdef SECBIT
	else if (_identifier.annotation().type && isSupportedType(_identifier.annotation().type->category()))
#else
